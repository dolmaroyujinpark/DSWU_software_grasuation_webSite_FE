    ...
    const developers = [
        {
            ...
            ment: "처음으로 긴 시간동안 팀별 프로젝트를경험해 볼 수 있었던 시간이었다. 주제부터결과물 제작까지 만들면서 정말 고생 많았고팀원들에게 고맙단 말을 하고 싶다.",
            photo: p1,
        },
        {
            name: "| 염혜선",
            role: "| 안드로이드 어플 제작",
            ment: "처음으로 안드로이드 어플을 처음부터 끝까지만들어본 경험을 할 수 있었다. 어려움도있었지만 정말 많이 배울 수 있는프로젝트였다. 일년동안 고생한 팀원들에게수고했다고 다시 한 번 말해주고 싶다.",
            photo: p2,
        },
        {
            name: "| 정현정",
            role: "| 선호도 기반 추천시스템, 모델학습기반 추천시스템",
            ment: "1년간의 캡스톤 프로젝트는 때론 지치기도했지만, 그 과정에서 얻은 경험은 매우 값졌다.팀원들과 협력하며 팀워크의 중요성을깨달았다. 함께해준 팀원들에게 감사의마음을 전한다.",
            photo: p3,
        },
        {
            name: "| 최예람",
        ...
        <div className="AppComp">
            ...
            <div className="App-header">
                ...
                <div className="description-content">
                    ...
                    <p>Tools : PyCharm, AndroidStudio, Unity, Firebase</p>
